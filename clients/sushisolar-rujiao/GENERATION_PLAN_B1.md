...
| **不可刪除措辭** | `confined to the far outer edge`（R11 限制框架物寬度）<br>`clearly visible in the central area`（R11 劃定中央安全區） |
...
| **不可刪除措辭** | `clear disposable plastic cup`（R10 玻璃杯配熱封膜物理不成立）<br>`sealed film lid`（R10 封膜是插吸管動作的接觸對象） |
