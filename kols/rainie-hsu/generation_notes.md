...
- [ ] 批次規劃 1–6 尚未送出生成（此為之後完整訓練集規劃，待 Reference Element 錨定後才依此重新調整生成；若之後要送出，須先比照本輪規則補上自拍/candid 視角混合＋日常穿搭，不能全數沿用棚拍語氣或招牌夜店造型）
...
- [ ] 使用者尚未挑選出核准的候選圖，也尚未針對本輪妝容結果與服裝結果給出最終回饋
