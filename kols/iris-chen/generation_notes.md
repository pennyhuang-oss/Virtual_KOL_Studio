...
## 【規劃中，尚未生成】`daily_expression_v5` — 表情系統首次驗證批次（6 張）

**狀態：⬜ 已規劃、待使用者核准後生成。本節不含任何實際生成結果。**

**背景**：外部觀看者指出 v1–v4 共 20 張「表情都是一號表情」，根因分析與解法見
`EXPRESSION_SYSTEM.md`（同日建立，全 11 位角色適用）。本批是該系統的第一次實際驗證。

**使用者對本批的三項指示（2026-08-12）**：

1. **不重做舊素材**——「舊有的素材雖然被 challenge 說表情都一樣，但那些素材沒有不好，還是可以使用，
   所以不需要用同樣的場景、服裝和妝造重新生成。如果要測試新表情，我們就直接用全新的一套來生成。」
   → 本批**全部場景、服裝、動作、髮型都是全新的**，不沿用 v1–v4 任何一組 setup。
2. **氛圍延續 v4**：一樣走性感、露膚的設計；場景以夜晚、房間或室內居多。
3. **異常確認機制**：只有環境或服裝跟設定稍有不同、但表情正常時，**先給使用者看，不要自動重生**
   （已寫入 `SEXY_SCENE_LIBRARY.md` 第 10-a 點與 QA workflow）。

> **方法上的取捨（記錄在案）**：`SEXY_SCENE_LIBRARY.md` 第 14 點建議用「1 個 setup × 6 種表情」測，
> 因為那樣表情是唯一變因、實驗最乾淨。**使用者選擇全部換新**，所以本批同時變動了場景/服裝/髮型/表情
> 四個變數——換得的是「6 張可直接各自成為貼文的素材」，付出的是「表情效果無法與其他變因完全隔離」。
> 若之後想要乾淨的 carousel，再從本批挑一組 setup 做 1×6 延伸即可。

### 六張的完整配置

| # | 場景（全新） | 服裝（全新，五層） | 髮型 | 表情 | 象限 | 視角 | 夜間光線 |
|---|---|---|---|---|---|---|---|
| 01 | **半夜開冰箱找東西吃**（廚房） | 男友版超大白 T（下襬到大腿根、領口滑落單肩）+ 光腳 + 細金鎖骨鍊 | H-2 隔夜亂髮、一邊被枕頭壓翹 | **E-5 抿嘴憋笑**（動機：半夜偷吃被室友抓到，忍住不笑） | 意識×高 | 自拍 | **冰箱內冷白光是畫面唯一光源**，不鏽鋼門板與白磁磚當反射面，廚房其餘全黑 |
| 02 | **書桌前看筆電**（臥室角落） | 深灰針織無袖背心（側邊鏤空到腰際）+ 低腰灰棉褲 + 光腳 + 銀戒 | H-3 鯊魚夾隨手盤 ＋**旁分長瀏海垂在兩頰**（首次動瀏海） | **E-8 專注做事**（動機：在看筆電上的東西，完全沒意識到鏡頭） | 無意識×低 | 他拍 | 筆電螢幕冷藍光由下前方打臉，桌角暖黃小夜燈為第二色溫，房間其餘壓黑三級 |
| 03 | **坐在浴缸邊緣、雙腿泡在水裡擦乳液** | 黑色細肩帶連身泳衣式內衣（濕的、貼身）+ 浴巾放在缸沿 + 金腳鍊 | H-1 濕髮全部往後撥、髮尾滴水 | **E-2 挑眉歪頭**（動機：對拍她的人有意見，「幹嘛」） | 意識×低 | 自拍 | 缸沿數支蠟燭為唯一光源，水面晃動的反射光打上她下巴，浴室遠端全黑 |
| 04 | **玄關靠著門框脫高跟鞋**（剛回到家） | 酒紅緞面細肩帶超短洋裝 + 細跟高跟鞋（已脫一隻拿在手上）+ 金色細鍊 + 小手拿包丟在地上 | H-4 吹整過的滑順放下 ＋**深旁分**（第二次動分線） | **E-4 開口大笑**（動機：室友在門口講了一句很好笑的話）⚠️ 前 20 張零出現 | 意識×高 | 他拍 | 玄關暖黃頂燈由正上方直下，屋內深處全黑，門外走廊冷白光從門縫切進來 |
| 05 | **陽台曬衣架旁講電話** | 絲質睡袍腰帶鬆綁敞開 + 內搭同色系小可愛與內褲 + 光腳 + 細金手鍊 | H-5 低雙辮（未用過的髮型） | **E-10 講話講到一半**（動機：正在講電話，被抓拍）| 無意識×高 | 他拍 | 室內落地門溢出的暖光從她背後，城市夜景冷藍光為第二色溫，曬衣架與衣服在畫面前景形成剪影 |
| 06 | **床尾地毯上伸長腿靠著床墊** | 黑色高衩連身緊身衣（bodysuit）+ 敞開的格紋襯衫滑落雙肩 + 金色腰鍊 | H-2 亂髮中分 ＋**空氣瀏海**（第三次動瀏海） | **E-1 半瞇微笑**（招牌，本批唯一 1 張） | 意識×低 | 自拍 | 床頭燈暖光從高處灑下，天花板上有投影機的冷藍光，房間其餘壓黑 |

### 分配規則自檢（對照 `EXPRESSION_SYSTEM.md` 第七節）

- [x] 招牌 E-1 只有 1 張（06）
- [x] 至少 1 張沒在看鏡頭 → 02（E-8）、05（E-10）共 2 張
- [x] 至少 1 張嘴巴打開看得到牙齒 → 04（E-4 大笑）、05（E-10 講話中）
- [x] 連續兩張不同象限 → 意高／無低／意低／意高／無高／意低，相鄰全部不同
- [x] 髮型 5 種狀態（H-1～H-5 全用上），且動了 3 次瀏海／分線
- [x] 對照 Iris 禁用欄：她的禁用是「對鏡頭比 pose 的甜笑」與「誇張驚訝」，本批**刻意不用 E-6 驚訝**，
      改用 E-5 抿嘴憋笑承接「被抓到」的情境——符合她 `character.md` 的內斂幽默
- [x] 自拍 3（01/03/06）／他拍 3（02/04/05）
- [x] 6 個場景、6 套服裝全部是 v1–v4 沒出現過的

### Prompt 撰寫規則（生成時必須遵守）

1. **夜間光線段落放 prompt 最前面**（`SEXY_SCENE_LIBRARY.md` 3-D，2026-08-12 實測結論）——
   v4 因為服裝描述變長，把光線擠到尾端，5 張有 3 張夜感失守
2. **表情寫滿三層**（`BROW:` / `EYES:` / `MOUTH:`）＋ 動機 ＋ 不對稱點 ＋ 眼睛落點
3. **服裝寫滿五層**（上身／下身／鞋／外套或包／首飾）
4. **手**：放對比色表面上或舉到臉旁，不可小又懸空（10-c）
5. 全程平視或微俯角，無低角度仰拍（第 16 點）
6. 私密場景不加背景路人（第 9 點）；陽台那張若帶到對面樓，只有燈光不要有人

### 預估成本

6 張初版 ≈ 6 次生成；若有 AI 瑕疵需重生，預估 +1～3 次。以 v1–v4 的實績推估總計 7–9 次生成。
